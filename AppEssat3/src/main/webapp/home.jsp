...
<body>
    ...
    <div class="container mt-4">
        ...
        <p>Bienvenue ${utilisateur.nom} (<a href="Dec">Déconnexion</a>)</p>
       <c:if test="${utilisateur.role == 'admin'}">
    <div><a href="PreAjout" class="btn btn-primary mb-3">Ajouter une note aux étudiants</a>
    <a href="AddEtudiant" class="btn btn-primary mb-3">Ajouter de nouveaux étudiants</a></div>
</c:if>
...
<td><a href="PreNote?id=${etudiant.id}">Voir les notes</a></td>
    ...
    <footer class="footer mt-auto py-3 bg-dark">
        <div class="container">
            <span class="text-muted">© 2024 - Hafnaoui Arij</span>
        </div>
    </footer>
